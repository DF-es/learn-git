...
export default function RewardsPage() {
  ...
  return (
    <section className="animate-fadeIn pb-10">
      <div className="flex justify-between items-end mb-16 border-b-2 border-[var(--border-color)] pb-4 font-cinzel tracking-widest">
        <h2 className="text-[2rem] text-[var(--text-main)] font-bold">
          報酬と免罪符
        </h2>
        <button
        ...
        >
          <i className="fa-solid fa-plus-circle text-lg"></i> 報酬設定
        </button>
      </div>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className={`p-4 px-10 rounded-[var(--radius-sm)] border-2 transition-all font-bold tracking-wider text-[1.1rem] ${
      ...
      >
        <div className="space-y-12">
          <div className="form-group">
            <label className="block text-[1.1rem] font-bold text-[var(--text-muted)] mb-5 uppercase tracking-widest opacity-80">
              報酬名 (やりたいこと・免罪符)
            </label>
            <input
              type="text"
          ...
          <button
            ...
            disabled={activeGuild.status === 'retired'}
            className={`w-full p-8 text-[1.8rem] rounded-[var(--radius-md)] font-bold transition-all shadow-lg hover:brightness-110 active:scale-95 ${
              activeGuild.status === 'retired'
